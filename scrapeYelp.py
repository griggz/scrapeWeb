"""
This code scrapes the yelp link you provide for reviews and outputs them into
 csv file.

sample 1: python scrapeYelp.py -l 'https://www.yelp.com/biz/kaigo-coffee-room-new-york-4?osq=Coffee+%26+Tea'
...
def fetch_reviews(link, num_pages):
    """
...
def scrape(link, num_pages=0):
    ...
    link : str
        ...
        e.g. https://www.yelp.com/biz/kaigo-coffee-room-new-york-4?osq=Coffee+%26+Tea
    ...
    reviews, biz_title = fetch_reviews(link, num_pages)
...
def main():
    ...
    parser.add_argument('-p', '--num_pages',
                        ...
                        help='enter the number of pages you would like reviews'
                             'to be pulled from. NOTE: 20 reviews per page or leave it blank to get all of them.')
